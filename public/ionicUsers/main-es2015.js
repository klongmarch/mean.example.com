...
const routes = [
    ...
    {
        path: 'logout',
        loadChildren: () => Promise.all(/*! import() | logout-logout-module */[__webpack_require__.e("common"), __webpack_require__.e("logout-logout-module")]).then(__webpack_require__.bind(null, /*! ./logout/logout.module */ "./src/app/logout/logout.module.ts")).then(m => m.LogoutPageModule)
    },
    {
        path: 'register',
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | user-edit-user-edit-module */[__webpack_require__.e("common"), __webpack_require__.e("user-edit-user-edit-module")]).then(__webpack_require__.bind(null, /*! ./user-edit/user-edit.module */ "./src/app/user-edit/user-edit.module.ts")).then(m => m.UserEditPageModule)
    },
    {
        path: 'user-edit',
        loadChildren: () => Promise.all(/*! import() | user-edit-user-edit-module */[__webpack_require__.e("common"), __webpack_require__.e("user-edit-user-edit-module")]).then(__webpack_require__.bind(null, /*! ./user-edit/user-edit.module */ "./src/app/user-edit/user-edit.module.ts")).then(m => m.UserEditPageModule)
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | user-delete-user-delete-module */[__webpack_require__.e("common"), __webpack_require__.e("user-delete-user-delete-module")]).then(__webpack_require__.bind(null, /*! ./user-delete/user-delete.module */ "./src/app/user-delete/user-delete.module.ts")).then(m => m.UserDeletePageModule)
    },
    {
        path: 'user-delete',
        loadChildren: () => Promise.all(/*! import() | user-delete-user-delete-module */[__webpack_require__.e("common"), __webpack_require__.e("user-delete-user-delete-module")]).then(__webpack_require__.bind(null, /*! ./user-delete/user-delete.module */ "./src/app/user-delete/user-delete.module.ts")).then(m => m.UserDeletePageModule)
...
module.exports = __webpack_require__(/*! /home/stkang/ionicUsers/src/main.ts */"./src/main.ts");
